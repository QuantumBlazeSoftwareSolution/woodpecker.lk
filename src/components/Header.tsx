...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-[#FDFBF7] border-b border-black/5 shadow-sm">
      {/* Top Row: Brand, Search, User Utility */}
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-6">
        
        {/* Left: Brand Mark */}
        <Link href="/" className="text-2xl font-serif font-extrabold text-[#261B14] tracking-widest hover:opacity-80 transition-opacity">
          WOODPECKER
        </Link>
